...
<form method="POST" id="teamspeak_serveredit" action="{url:teamspeak_serveredit}" enctype="multipart/form-data">
<table class="forum" style="width:{page:width}" cellpadding="0" cellspacing="{page:cellspacing}">
	<tr>
		<td class="leftc">{icon:ts1} {lang:serverip} *</td>
		<td class="leftb"><input type="text" name="teamspeak_ip" value="{teamspeak:teamspeak_ip}" maxlength="30" size="30" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="leftb"><input type="hidden" name="teamspeak_id" value="{teamspeak:teamspeak_id}"><input type="submit" name="submit" value="{lang:edit}" /></td>
	</tr>
</table>
</form>