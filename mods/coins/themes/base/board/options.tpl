...
<form method="post" id="board_edit" action="{action:form}">
 ...
 <tr>
  ...
  <td class="leftb"><input type="text" name="date_format" value="{options:date_format}" maxlength="80" size="10" /> {options:date_format_example}</td>
 </tr>
 <tr>
   <td class="leftc">{icon:bets} {options:coins_receive_text}</td>
   <td class="leftb"><input type="text" name="coins_receive" value="{options:coins_receive}" maxlength="20" size="4" /></td>
 </tr>
 <tr>
   <td class="leftc">{icon:bets} {options:coins_receive_thread_text}</td>
   <td class="leftb"><input type="text" name="coins_receive_thread" value="{options:coins_receive_thread}" maxlength="20" size="4" /></td>
 </tr>
 <tr>
   <td class="leftc">{icon:bets} {options:coins_checkbox_thread_text}</td>
   <td class="leftb"><input type="checkbox" name="coins_checkbox_thread" {options:coins_checkbox_thread} /></td>
 </tr>
 <tr>
   <td class="leftc">{icon:bets} {options:coins_min_length_text}</td>
   <td class="leftb"><input type="text" name="coins_min_length" value="{options:coins_min_length}" maxlength="20" size="4" /></td>
 </tr>
