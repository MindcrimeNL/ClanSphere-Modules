...
if(!empty($error) OR !isset($_POST['submit']) OR isset($_POST['preview'])) {
 ...
 echo cs_subtemplate(__FILE__,$data,'board','thread_edit');
	...
	$thread_cells = array('threads_headline','threads_text','threads_edit', 'threads_last_time');
	$thread_save = array($board['threads_headline'],$board['threads_text'],$threads_edit, (int) cs_time());
 cs_sql_update(__FILE__,'threads',$thread_cells,$thread_save,$thread_id);
	include('mods/coins/thread_edit.php');
