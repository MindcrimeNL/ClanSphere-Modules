...
function w3g_convert_bool($value) {
	if (!$value)
		return false;
...
function w3g_convert_speed($value) {
	switch ($value) {
...
function w3g_convert_visibility($value) {
	switch ($value) {
...
function w3g_convert_observers($value) {
	switch ($value) {
...
function w3g_convert_game_type($value) {
	switch ($value) {
...
function w3g_convert_color($value) {
	switch ($value) {
...
function w3g_convert_race($value) {
	switch ($value) {
...
function w3g_convert_select_mode($value) {
	switch ($value) {
...
function w3g_convert_chat_mode($value, $player='unknown') {
	switch ($value) {
...
function w3g_convert_itemid($value) {
...
function w3g_convert_buildingid($value) {
	// non-ASCII ItemIDs
	if (ord($value{0}) < 0x41 || ord($value{0}) > 0x7A) {
		return 0;
	}
...
function w3g_convert_action($value) {
	switch ($value) {
...
function w3g_convert_time($value) {
...
function w3g_convert_yesno($value) {
	if (!$value)
		return 'No';
...
function w3g_convert_color_html($value) {
	switch ($value) {
