...
$where = 'replays_access <> 0 AND replays_access <= '.$account['access_replays'];
...
$data['head']['pages'] = cs_pages('replays','list',$replays_count,$start,$categories_id,$sort);
...
$data['replays'] = cs_sql_select(__FILE__,'replays',$select,$where,$order,$start,$account['users_limit']);
$replays_loop = count($data['replays']);

$data['sort']['date'] = cs_sort('replays','list',$start,$categories_id,1,$sort);
$data['sort']['team1'] = cs_sort('replays','list',$start,$categories_id,3,$sort);
$data['sort']['team2'] = cs_sort('replays','list',$start,$categories_id,5,$sort);
