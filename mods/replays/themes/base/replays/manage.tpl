...
<table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
 <tr>
  ...
  <td class="headb">{lang:needed_access}</td>
  <td class="headb">{lang:downloads}</td>
...
{loop:replays}
 <tr>
  ...
  <td class="leftc">{replays:access}</td>
  <td class="rightc">{replays:replays_count_downloads}</td>
