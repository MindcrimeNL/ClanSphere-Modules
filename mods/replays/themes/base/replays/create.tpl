...
<table class="forum" style="width:{page:width}" cellpadding="0" cellspacing="{page:cellspacing}">
	...
	{if:plugin}
	<tr>
		<td class="leftc">{icon:package_games} {lang:plugins}</td>
		<td class="leftb">
...
{plugin:javascript}
				...
				{loop:plugins}
				<input type="checkbox" name="plugin_{plugins:name}" id="plugin_{plugins:name}" value="1"{plugins:disabled}{plugins:checked}> {plugins:fullname}<br />{plugins:info}</br>
				{stop:plugins}
		</td>
	</tr>
	{stop:plugin}
