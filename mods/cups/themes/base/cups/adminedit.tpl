...
<table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
  ...
  <tr>
    ...
    <td class="leftb">
      <input type="checkbox" name="cupmatches_accepted1" value="1"{checked:team1} /> {match:team1_name} {match:dtcon} {match:time1}<br />
      <input type="checkbox" name="cupmatches_accepted2" value="1"{checked:team2} /> {match:team2_name} {match:dtcon} {match:time2}</td>
  </tr>
  <tr>
